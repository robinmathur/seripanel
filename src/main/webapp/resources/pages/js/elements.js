jQuery(document).ready(function(){
	...
	if(jQuery('.promptbutton').length > 0) {
		...
		(function(){
			jPrompt('NOTE: Any pre given rating of same module will be overridden!!! <br>Enter Comments:<textarea id="popup_prompt"></textarea>', 'Prefilled value', 'Prompt Dialog', function(r) {
				if( r ) alert('You entered x' + r);
			});
		});
	}
