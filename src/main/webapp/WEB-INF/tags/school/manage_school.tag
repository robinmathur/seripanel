        ...
        <table class="table table-bordered responsive">
            ...
            <c:forEach var="schoolItem" items="${schoolList}">
                <tr>
                    ...
                    <td>Principal Name : <utilLibs:parentNameUsingId loginId="${schoolItem.principal}" /><br><a href="/teacher/manage/?schoolid=${schoolItem.schoolId}">No of teachers :  <schoolLibs:schoolTeacherCount schoolId="${schoolItem.schoolId}" /></a> | <a href="/student/manage/?schoolid=${schoolItem.schoolId}">No of Students : <schoolLibs:schoolStudentCount schoolId="${schoolItem.schoolId}" /></a> | <a href="/hod/manage/?schoolid=${schoolItem.schoolId}">No of HOD : <hodLibs:schoolHodCount schoolId="${schoolItem.schoolId}" /></a></td>
                    <td>
