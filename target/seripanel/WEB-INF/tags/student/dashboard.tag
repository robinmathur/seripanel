    ...
    <c:when test="${fn:length(subjectList)>0}">
        ...
        <table class="table table-bordered responsive">
            ...
            <tr>
                ...
                <th class="head0">Home Work</th>
                <th class="head1">Class Work</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${subjectList}" var="subject">
                <tr>
                    ...
                    <td class="center"><a href="/tasks/viewtask/?subjectid=${subject.subjectId}&taskname=home_work">View / Update Task</a></td>
                    <td class="center"><a href="/tasks/viewtask/?subjectid=${subject.subjectId}&taskname=class_work">View / Update Task</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
